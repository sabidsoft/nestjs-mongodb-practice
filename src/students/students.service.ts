...
export class StudentsService {
    ...
    async updatePutStudent(id: string, data: CreateStudentDto): Promise<StudentDocument | null> {
        return this.studentModel.findOneAndReplace({ _id: id }, data, { runValidators: true }).exec();
    };
